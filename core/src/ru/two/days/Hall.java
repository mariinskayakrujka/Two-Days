...
public class Hall extends ScreenGame {
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.justTouched() ) {
            ...
            if(gg.touch.x < /*размеры двери*/ && gg.touch.x > /*размеры двери*/){
               runa.moveForRuna(gg.touch.x, 0.01f);
            ...
            if (gg.touch.y < /*размеры двери*/ && gg.touch.y > /*размеры двери*/ && gg.touch.x >/*размеры двери*/ &&
                    gg.touch.x </*размеры двери*/&& numberOfHalls == 5){
