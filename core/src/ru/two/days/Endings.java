...
public class Endings {
    ...
    void goodEnding() {
        endfOfGame.add("Руна отлично защитила дипломную,\n хоть было страшно.");
        endfOfGame.add("Она смотрела на ректора на Ст,\n сидевшего на первых рядах\n и внимательно глядевшего прямо ей в глаза. ");
        endfOfGame.add("Он был напряжен,");
        ...
        endfOfGame.add("Нашла Кайден, извинилась и перед ней за свое поведение.");
    ...
    void faintingInProtection() {
        ...
        endfOfGame.add("Она посмотрела на Ст, необычайно напряженного,");
